...
const categories = [
  { name: 'Rings', slug: 'rings', description: 'Beautiful rings for every occasion', order: 1 },
  { name: 'Necklaces', slug: 'necklaces', description: 'Elegant necklaces and pendants', order: 2 },
  { name: 'Earrings', slug: 'earrings', description: 'Stunning earrings collection', order: 3 },
  { name: 'Bracelets', slug: 'bracelets', description: 'Charming bracelets and bangles', order: 4 },
  { name: 'Anklets', slug: 'anklets', description: 'Graceful anklets', order: 5 }
];
